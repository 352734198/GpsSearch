...
public class BarChartRenderer extends DataRenderer {
    ...
    public void drawData(Canvas c) {
        ...
        for (int i = 0; i < barData.getDataSetCount(); i++) {
            ...
            IBarDataSet set = barData.getDataSetByIndex(i);
            System.out.println("-------->>> drawData  i =" + i + set.getYValForXIndex(0) );
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        System.out.println("---------------->>>draawdata set  index =" + index);
        ...
        System.out.println("-----getBarSpace =" + dataSet.getBarSpace());
        ...
        System.out.println("---------->>> mChart.isDrawBarShadowEnabled() = " + mChart.isDrawBarShadowEnabled());
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int j = 0; j < buffer.size(); j += 4) {
                ...
                if (!mViewPortHandler.isInBoundsRight(buffer.buffer[j]))
                    break;
                System.out.println("------------??? mViewPortHandler.contentTop() = " +mViewPortHandler.contentTop());
    ...
    public void drawExtras(Canvas c) {
        ...
        System.out.println("------------->>> drawExtras fuck");
    }
}
